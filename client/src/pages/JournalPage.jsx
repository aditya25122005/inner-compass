      ...
      <div className="card shadow-sm p-4">
        ...
        <div className="d-flex justify-content-center mb-4">
          <button
            ...
            className={`btn btn-light me-2 ${mood === "happy" ? "shadow" : ""}`}
          >
            <span role="img" aria-label="happy" style={{ fontSize: "2rem" }}>
              😄
            </span>
          </button>
          <button
            onClick={() => setMood("calm")}
            className={`btn btn-light me-2 ${mood === "calm" ? "shadow" : ""}`}
          >
            <span role="img" aria-label="calm" style={{ fontSize: "2rem" }}>
              😌
            </span>
          </button>
          <button
            onClick={() => setMood("sad")}
            className={`btn btn-light me-2 ${mood === "sad" ? "shadow" : ""}`}
          >
            <span role="img" aria-label="sad" style={{ fontSize: "2rem" }}>
              😔
            </span>
          </button>
          <button
            onClick={() => setMood("angry")}
            className={`btn btn-light me-2 ${mood === "angry" ? "shadow" : ""}`}
          >
            <span role="img" aria-label="angry" style={{ fontSize: "2rem" }}>
              😠
            </span>
          </button>
        </div>
